...
VL_ATTR_COLD void Vtop_REG_BUS__A6_D20___ctor_var_reset(Vtop_REG_BUS__A6_D20* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_REG_BUS__A6_D20___ctor_var_reset\n"); );
    // Body
    vlSelf->clk_i = VL_RAND_RESET_I(1);
    vlSelf->addr = VL_RAND_RESET_I(6);
